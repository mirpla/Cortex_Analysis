...
try
    ...
    for trial = 1:numTrials
        ...
        cd('C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Movies37.5'); 
        ...
        [wav_orig,Fs]=audioread(['C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Sounds37.5\' practices.soundfolder{trial,1} '/' practices.soundname{trial,1}]); 
        ...
        cd 'C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\RatingsData'; 
    ...
    for testtrial = 1:numTrials
        ...
        %------------------------------------------------------------------------------------------------------
        [wav_orig,Fs]=audioread(['C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Sounds37.5\' practicet.soundfolder{testtrial,1} '/' practicet.soundname{testtrial,1}]); 
        % prepare to play the sound by adding it to the audio buffer in advance
        PsychPortAudio('FillBuffer', pahandle, wav_orig');
    ...
    cd 'C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\TestData'; 
    mkdir(['subj' num2str(participant_num)]);
