...
try
    ...
    for trial = 1:numTrials
        ...
        cd('/Users/maxwellwiggins/Documents/Project/materials/materials_files/movies/Movies'); 
        ...
        [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds\' practices.soundfolder{trial,1} '/' practices.soundname{trial,1}]); 
    ...
    for testtrial = 1:numTrials
        ...
        %------------------------------------------------------------------------------------------------------
        [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds\' practicet.soundfolder{testtrial,1} '/' practicet.soundname{testtrial,1}]); 
        % prepare to play the sound by adding it to the audio buffer in advance
        PsychPortAudio('FillBuffer', pahandle, wav_orig');
    ...
    for block = 1:16
        %load file
        cd(['/Users/maxwellwiggins/Documents/Project/csv/subj',num2str(participant_num)]);
        ...
        for trial = 1:numTrials
            ...
            %------------------------------------------------------------------------------------------------------
            % read audio file, call it wav_orig, sample rate is Fs
            [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds\' blocks.soundfolder{trial,1} '/' blocks.soundname{trial,1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
        ...
        for testtrial = 1:numTrials
            ...
            %   1.2 Read in and prepare audio - see comments in the encoding section
            %------------------------------------------------------------------------------------------------------
            [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds\' blockt.soundfolder{testtrial,1} '/' blockt.soundname{testtrial,1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
    ...
    for block = 1:2
        ...
        for trial = 1:numTrials
            ...
            %------------------------------------------------------------------------------------------------------
            % read audio file, call it wav_orig, sample rate is Fs
            [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds\' syncfile.soundfolder{shuffler(trial),1} '/' syncfile.soundname{shuffler(trial),1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
        ...
        cd '/Users/maxwellwiggins/Documents/Project/Behav_Data/SyncData'; 
        mkdir(['subj' num2str(participant_num)]);
        cd(['/Users/maxwellwiggins/Documents/Project/Behav_Data/SyncData\subj' num2str(participant_num)]);
