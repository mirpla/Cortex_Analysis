...
try
    ...
    %load practice file
    cd /Users/maxwellwiggins/Documents/Project/Memory_Exp/csv;
    ...
    for trial = 1:numTrials
        ...
        cd('/Users/maxwellwiggins/Documents/Project/materials/materials_files/movies/Movies37.5'); 
        ...
        [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds/gamma_34ms/' practices.soundfolder{trial,1} '/' practices.soundname{trial,1}]); 
        ...
        cd '/Users/maxwellwiggins/Documents/Project/Behav_Data/RatingsData'; 
        mkdir(['subj' num2str(participant_num)]);
        cd(['/Users/maxwellwiggins/Documents/Project/Behav_Data/RatingsData/subj' num2str(participant_num)]);
    ...
    %load practice file
    cd /Users/danying/Documents/Experiments/GTB/csv;
    ...
    for testtrial = 1:numTrials
        ...
        %------------------------------------------------------------------------------------------------------
        [wav_orig,Fs]=audioread(['/Users/maxwellwiggins/Documents/Project/materials/materials_files/sounds/gamma_34ms\' practicet.soundfolder{testtrial,1} '/' practicet.soundname{testtrial,1}]); 
        % prepare to play the sound by adding it to the audio buffer in advance
        PsychPortAudio('FillBuffer', pahandle, wav_orig');
    ...
    cd '/Users/maxwellwiggins/Documents/Project/Behav_Data/TestData'; 
    mkdir(['subj' num2str(participant_num)]);
    cd(['/Users/maxwellwiggins/Documents/Project/Behav_Data/TestData/subj' num2str(participant_num)]);
    ...
    for block = 1:16
        %load file
        cd(['/Users/maxwellwiggins/Documents/Project/Memory_Exp/csv/subj1',num2str(participant_num)]);
        %cd(['C:\Users\colles-a-l-hanslmas\Documents\Project\csv\subj',num2str(participant_num)]);
        ...
        for trial = 1:numTrials
            ...
            cd('C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Movies'); 
            ...
            %------------------------------------------------------------------------------------------------------
            % read audio file, call it wav_orig, sample rate is Fs
            [wav_orig,Fs]=audioread(['C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Sounds\' blocks.soundfolder{trial,1} '/' blocks.soundname{trial,1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
            ...
            cd(['C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\RatingsData\subj' num2str(participant_num)]);
            export(RatingsData, 'file', savename, 'Delimiter', ',');
        end
        ...
        for testtrial = 1:numTrials
            ...
            %   1.2 Read in and prepare audio - see comments in the encoding section
            %------------------------------------------------------------------------------------------------------
            [wav_orig,Fs]=audioread(['C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Sounds\' blockt.soundfolder{testtrial,1} '/' blockt.soundname{testtrial,1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
        ...
        cd(['C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\TestData\subj' num2str(participant_num)]);
        export(TestData, 'file', testsavename, 'Delimiter', ',');
    ...
    for block = 1:2
        ...
        for trial = 1:numTrials
            ...
            %------------------------------------------------------------------------------------------------------
            % read audio file, call it wav_orig, sample rate is Fs
            [wav_orig,Fs]=audioread(['C:\Users\colles-a-l-hanslmas\Documents\Project\materials\materials_files\Sounds\' syncfile.soundfolder{shuffler(trial),1} '/' syncfile.soundname{shuffler(trial),1}]); 
            % prepare to play the sound by adding it to the audio buffer in advance
            PsychPortAudio('FillBuffer', pahandle, wav_orig');
        ...
        cd 'C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\SyncData'; 
        mkdir(['subj' num2str(participant_num)]);
        cd(['C:\Users\colles-a-l-hanslmas\Documents\Project\Behav_Data\SyncData\subj' num2str(participant_num)]);
